...
1. open analysis-notebook.ipynb
2. execute code 'chunks' (focus and shift + enter)
3. export to pdf/html/... via menu bar
...
---
# One step further: markdown + knitr + pandoc
...
- easy to use, source document is readable even with just a text editor
...
- knitr primarily for R, pweave for Python
...
- long running steps should be cached during development
...
- can be used with slurm scheduler to exploit parallelism on an HPC slurm cluster
